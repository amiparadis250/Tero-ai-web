    ...
    <section className="bg-white text-gray-900 transition-colors duration-300 dark:bg-black  dark:text-white">
      <nav className="container mx-auto flex items-center justify-between p-4">
        <div className="flex items-center">
          ...
          <span className="text-xl font-bold">TERO AI</span>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <button onClick={toggleMobileMenu} className="md:hidden" title="Open mobile menu">
        ...
        >
          <div className="p-6">
            <div className="mb-8 flex items-center justify-between">
              ...
              <button onClick={toggleMobileMenu} title="Close mobile menu">
                <X className="size-6" />
              </button>
            </div>
      ...
      <div className="container mx-auto grid grid-cols-2 gap-8 px-4 py-16 md:grid-cols-4">
        {[
          { number: "500+", text: "Farmers reached" },
          { number: "2+", text: "Awards Received" },
          { number: "2+", text: "Years of experience" },
          { number: "+3", text: "Team members" },
        ].map((stat, index) => (
          <div
            key={index}
